...
class RoomCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setEntityNameStrings('lơp học', 'các lớp học');
    ...
    {
        CRUD::column('name')->label("Tên lớp học");
        CRUD::column('code')->label("Mã lớp");;
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('name')->label("Tên lớp học");
        CRUD::field('code')->label("Mã lớp");
